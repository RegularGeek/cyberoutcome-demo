        ...
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Nigeria</h3>
            ...
            <div>
              <div className="w-16 h-1 bg-blue-600 mx-auto mb-6"></div>
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Ghana</h3>
              <p className="text-gray-700 mb-2">
                Silver Star Towers,
                <br />
            ...
            <div>
              <div className="w-16 h-1 bg-blue-600 mx-auto mb-6"></div>
              <h3 className="text-2xl font-bold text-blue-600 mb-4">Kenya</h3>
              <p className="text-gray-700 mb-2">
